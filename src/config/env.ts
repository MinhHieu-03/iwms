...
function getBooleanEnvVariable(
  key: string,
...
const config: EnvConfig = {
  ...
  FEATURE_WAREHOUSE_VISUALIZATION: getBooleanEnvVariable(
    "FEATURE_WAREHOUSE_VISUALIZATION",
    true
  ),
  ...
  // WCS Auth Token
  WCS_AUTH_TOKEN: getEnvVariable("WCS_AUTH_TOKEN", ""),
