...
const Warehouse2DView: React.FC<Warehouse2DViewProps> = ({
  ...
  // Get the maximum row and column to create the grid
                      ...
                      {Array.from({ length: maxCol }, (_, colIndex) => {
                        ...
                        if (!rack) {
                          return (
                            <div 
                              key={`${row}-${col}`} 
                              className="w-12 h-12 border border-dashed border-gray-300 rounded flex items-center justify-center text-xs text-gray-400"
                            >
                              -
                            </div>
                          );
                        ...
                        return (
                          <HoverCard key={rack.id}>
                            <HoverCardTrigger asChild>
                              ...
                              >
                                <span className="z-10">{rack.locationCode}</span>
                              </button>
                            </HoverCardTrigger>
