...
import { PickingItem } from "./OddPickingDrawer";
...
const SplitOrder = ({ selectedItem, setCurrent, handleClose }) => {
  ...
  return (
    <div className="space-y-4 mt-5 bg-gray-50 p-4 rounded-lg">
      {/* Highlighted SKU at the top */}
      <div className="mb-6 p-4 bg-gradient-to-r from-yellow-400 to-yellow-500 rounded-lg shadow-lg border-2 border-yellow-600">
        <div className="flex items-center justify-center gap-3">
          <p className="text-lg font-bold text-yellow-900">SKU:</p>
      ...
      {/* Combined Order and Picking box */}
      <div className="mb-4 p-3 bg-white rounded-lg shadow-sm border-2 border-blue-200">
        <div className="grid grid-cols-3 gap-3">
          ...
          <div className="text-center">
            <p className="text-sm text-orange-600 font-medium mb-1">Action</p>
            <div className="flex justify-center">
              <span className="inline-flex items-center px-4 py-2 rounded-lg text-sm font-bold bg-blue-500 text-white shadow-md border-2 border-green-600">
                PICK ORDER
              </span>
            </div>
          </div>
          ...
          <div className="text-center">
            <p className="text-sm text-green-600 font-medium mb-1">Quantity to Pick</p>
            <div className="flex items-center justify-center gap-2">
              <span className="text-2xl font-bold text-green-600">{current}</span>
              <span className="text-lg text-gray-400 font-medium">of</span>
      ...
      <div className="mb-4 p-3 bg-white rounded-lg shadow-sm border-2 border-blue-200">
        <div className="grid grid-cols-3 gap-3">
          ...
          <div className="text-center">
            ...
            <div className="flex justify-center">
              <span className="inline-flex items-center px-4 py-2 rounded-lg text-sm font-bold bg-green-500 text-white shadow-md border-2 border-green-600">
                PICKED
              </span>
            </div>
          </div>
