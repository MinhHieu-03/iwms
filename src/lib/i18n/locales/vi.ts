...
export const vi: Record<TranslationKey, string> = {
  ...
  'area.messages.create_success': 'Tạo khu vực thành công',
  'area.messages.update_success': 'Cập nhật khu vực thành công',
  'area.messages.delete_success': 'Xóa khu vực thành công',
  'area.messages.create_error': 'Lỗi khi tạo khu vực',
  'area.messages.update_error': 'Lỗi khi cập nhật khu vực',
  'area.messages.delete_error': 'Lỗi khi xóa khu vực',
  ...
  'common.create_success': 'Tạo mục thành công',
  'common.create_error': 'Lỗi khi tạo mục',
  'common.update_success': 'Cập nhật mục thành công',
  ...
  'master_data.material_no': 'Mã vật liệu',
  'master_data.material_nm': 'Tên vật liệu',
  'master_data.material_tp': 'Loại vật liệu',
  'master_data.pk_style': 'Qui cách đống gói ncc',
  'master_data.new_pk_style': 'Qui cách đống gói mới',
  'master_data.flg': 'Cờ',
  ...
  'master_data.upload_success': 'Tải lên tệp thành công',
  'master_data.upload_error': 'Tải lên tệp thất bại',
  'master_data.download_success': 'Tải xuống tệp thành công',
  'master_data.download_error': 'Tải xuống tệp thất bại',
  'master_data.validation.material_no_required': 'Mã vật liệu là bắt buộc',
