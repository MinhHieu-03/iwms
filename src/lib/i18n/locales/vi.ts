...
export const vi: Record<TranslationKey, string> = {
  ...
  'master_data': 'Quản lý dữ liệu chính',
  'master_data.material_no': 'Số vật liệu',
  'master_data.material_nm': 'Tên vật liệu',
  'master_data.material_tp': 'Loại vật liệu',
  'master_data.pk_style': 'Kiểu PK',
  'master_data.new_pk_style': 'Kiểu PK mới',
  'master_data.flg': 'Cờ',
  'master_data.comment': 'Ghi chú',
  'master_data.user_id': 'ID người dùng',
  'master_data.ent_dt': 'Ngày nhập',
  'master_data.upd_dt': 'Ngày cập nhật',
  'master_data.create_master_data': 'Tạo dữ liệu chính',
  ...
  'master_data.validation.material_no_required': 'Số vật liệu là bắt buộc',
  'master_data.validation.material_nm_required': 'Tên vật liệu là bắt buộc',
  'master_data.validation.material_tp_required': 'Loại vật liệu là bắt buộc',
};
