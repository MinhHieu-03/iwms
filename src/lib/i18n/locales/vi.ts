...
export const vi: Record<TranslationKey, string> = {
  ...
  'common.confirm_bulk_delete_message': 'Bạn có chắc chắn muốn xóa {{count}} mục đã chọn?',
  ...
  'rack.rcs': 'RCS',
  'rack.rcs.tooltip': 'Mã định danh Hệ thống Điều khiển Robot cho vị trí kệ này',
  ...
  'rack.search.placeholder': 'Tìm kiếm theo mã vị trí, kho hàng hoặc khu vực...',
  ...
  'inventory.description': 'Quản lý và theo dõi hàng tồn kho tại các vị trí trong kho',
  ...
  'inventory.search_placeholder': 'Tìm kiếm theo SKU, tên sản phẩm hoặc vị trí...',
