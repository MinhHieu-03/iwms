...
export const en: Record<TranslationKey, string> = {
  ...
  select_exactly_2_nodes_description: 'You need to select exactly 2 nodes to create an edge between them',
  ...
  'storage_hierarchy_instructions.double_click': '• Double-click to edit node names',
  'storage_hierarchy_instructions.delete_key': '• Delete key to remove selected items',
  'storage_hierarchy_instructions.drag_rearrange': '• Drag to rearrange nodes',
  'storage_hierarchy_instructions.drag_connect': '• Drag from node edge to create connections',
  'storage_hierarchy_instructions.select_connect': '• Select 2 nodes + click "Connect" button',
  ...
  'warehouse_layout.select_area_prompt': 'Please select an area from the tabs above.',
  ...
  'inventory.description': 'Manage and track inventory items across warehouse locations',
  'inventory.sku': 'SKU',
  ...
  'inventory.location_code_placeholder': 'Enter location code (e.g., A-02/05-02)',
