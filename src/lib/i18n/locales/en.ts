...
export const en: Record<TranslationKey, string> = {
  ...
  'user_management.name_placeholder': 'Enter user name',
  'user_management.name_required': 'Name is required',
  'user_management.email': 'Email',
  'user_management.email_placeholder': 'Enter email address',
  'user_management.email_required': 'Email is required',
  'user_management.email_invalid': 'Please enter a valid email address',
  'user_management.password': 'Password',
  'user_management.password_placeholder': 'Enter password',
  ...
  'user_management.role_required': 'Role is required',
  'user_management.role_admin': 'Administrator',
  'user_management.role_manager': 'Manager',
  'user_management.role_operator': 'Operator',
  'user_management.role_viewer': 'Viewer',
  'user_management.status': 'Status',
  'user_management.status_required': 'Status is required',
  'user_management.status_active': 'Active',
  'user_management.status_inactive': 'Inactive',
  'user_management.department': 'Department',
  'user_management.department_placeholder': 'Enter department',
  'user_management.department_required': 'Department is required',
  'user_management.created_date': 'Created Date',
