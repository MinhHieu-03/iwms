export const en = {
  ...
  "issue_time_schedule.message.create_success":
    "Issue time schedule created successfully",
  "issue_time_schedule.message.update_success":
    "Issue time schedule updated successfully",
  "issue_time_schedule.message.delete_success":
    "Issue time schedule deleted successfully",
  "issue_time_schedule.message.delete_confirm":
    "Are you sure you want to delete this issue time schedule?",
